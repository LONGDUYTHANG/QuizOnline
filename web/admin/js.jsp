...
<html>
    <script >
        function changeId() {
            ...
            var month_user=document.getElementById('month_user');
            ...
            var week_user=document.getElementById('week_user');
...
<!--chart for month user    -->
    <script>
        //chart for month user
        document.addEventListener("DOMContentLoaded", function () {
            var ctx = document.getElementById("chartjs-dashboard-month-user").getContext("2d");
            var gradient = ctx.createLinearGradient(0, 0, 0, 2, 25);
            gradient.addColorStop(0, "rgba(215, 227, 244, 1)");
            gradient.addColorStop(1, "rgba(215, 227, 244, 0)");
            var list = [1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100];
            for (var i = 0; i < list.length; i++) {
                list[i] = parseInt(document.getElementById('mu' + i).innerHTML);
            }

            new Chart(document.getElementById("chartjs-dashboard-month-user"), {
                type: "line",
                data: {
                    labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
                    datasets: [{
...
<!--chart for week user    -->
    <script>
        //chart for week user
        document.addEventListener("DOMContentLoaded", function () {
            var ctx = document.getElementById("chartjs-dashboard-week-user").getContext("2d");
            var gradient = ctx.createLinearGradient(0, 0, 0, 2, 25);
            gradient.addColorStop(0, "rgba(215, 227, 244, 1)");
            gradient.addColorStop(1, "rgba(215, 227, 244, 0)");
            var list = [1000, 1100, 1200, 1300, 1400, 1500, 1600];
            for (var i = 0; i < list.length; i++) {
                list[i] = parseInt(document.getElementById('wu' + i).innerHTML);
            }

            new Chart(document.getElementById("chartjs-dashboard-week-user"), {
                type: "line",
                data: {
                    labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
                    datasets: [{
