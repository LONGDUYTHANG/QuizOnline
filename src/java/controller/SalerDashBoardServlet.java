...
public class SalerDashBoardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        double all_week_revenue=myRegistrationDAO.getAllWeekRevenue(LocalDate.now().minusDays(7));
        ...
        int all_week_registration=myRegistrationDAO.getAllWeekRegitration(LocalDate.now().minusDays(7));
